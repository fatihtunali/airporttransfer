      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 via-teal-900 to-cyan-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="tel:+902165575252" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-teal-500 text-white font-bold rounded-full hover:bg-teal-600 transition-all">
