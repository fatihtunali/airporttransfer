                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div ref={fromRef} className="relative">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-4 bg-gray-50 border-2 border-gray-100 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-teal-500 focus:bg-white transition-all duration-200"
                      required
                    />
                  ...
                  <div ref={toRef} className="relative">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-4 bg-gray-50 border-2 border-gray-100 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-teal-500 focus:bg-white transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-3.5 bg-gray-50 border-2 border-gray-100 rounded-xl text-gray-900 focus:outline-none focus:border-teal-500 focus:bg-white transition-all duration-200"
                        required
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-3.5 bg-gray-50 border-2 border-gray-100 rounded-xl text-gray-900 focus:outline-none focus:border-teal-500 focus:bg-white transition-all duration-200 cursor-pointer"
                      >
