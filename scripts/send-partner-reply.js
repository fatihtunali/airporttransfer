...
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Arial, sans-serif; background-color: #f5f7fa;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="text-align: center; padding: 20px; color: #9ca3af; font-size: 12px;">
      <p style="margin: 0;">© 2025 Airport Transfer Portal. All rights reserved.</p>
...
async function sendEmails() {
  console.log('Sending partnership reply emails...\n');
  ...
  for (const r of recipients) {
    ...
    try {
      const result = await resend.emails.send({
        ...
        to: r.email,
        subject: 'Re: Partnership Opportunity - How to Join Airport Transfer Portal',
        html: getHtml(r.name),
